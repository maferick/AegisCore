...
def _primary_ship(
    ...
    Role-level overrides (Monitor → FC, etc.) live in battle_role_scoring
    where they read killmail truth directly; this keeps features honest
    to the aggregate behavior signal."""
