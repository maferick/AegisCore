"""Structured-ish logging — fifth copy of the same kv formatter
(sde_importer + graph_universe_sync + market_poller + market_importer
all carry it). At five copies the cost of promoting to
`python/_common/` is finally meaningful; tracked as a follow-up,
not blocking the outbox_relay landing.
"""
