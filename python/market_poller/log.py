...
requirements files, and introducing a `python/_common/` package just
to dedupe ~100 lines of stdlib-logging glue isn't worth the
cross-image coupling.

If a fourth tool lands needing the same wrapper, promote this to
`python/_common/` then. Three copies is still under the "rule of
three" tripwire — the implementations haven't diverged.
"""
