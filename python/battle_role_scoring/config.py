"""Env-driven config. Same shape as battle_features / battle_partition."""
...
class Config:
    ...
    def from_env(cls) -> "Config":
        ...
        return cls(
            ...
            default_weight_label=env("BATTLE_SCORING_WEIGHT_LABEL", "v0_scoring_seed"),
        )
