...
return new class extends Migration
{
    ...
    {
        // Raw DDL only — same reason as market_history. The original
        // `Schema::create('market_orders', function () { DB::statement(...); })`
        // shape had Laravel build an empty `CREATE TABLE market_orders ()`
