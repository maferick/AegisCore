...
// EVE SSO — OAuth2 PKCE against login.eveonline.com. Two flows share the
// same callback URL (so the registered CCP app only needs one redirect
// URI on file), with a session-stashed `flow` marker telling the callback
...
// (+ phase-2 amendment for the service flow rationale).
