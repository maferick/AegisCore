    ...
    <div style="display:grid; grid-template-columns: {{ $colWidth }}; gap:0.6rem; overflow-x:auto;">
        @foreach ($regions as $region)
            @php
                ...
                $mapWidth = 560; $mapHeight = 440; $padding = 24;
            ...
            @endphp
            <div style="background:#0b0e14; border:1px solid rgba(255,255,255,0.06); border-radius:6px; padding:0.4rem 0.5rem;">
                ...
                <svg viewBox="0 0 {{ $mapWidth }} {{ $mapHeight }}"
                     ...
                     style="width:100%; height:auto; display:block; min-height:380px;">
                    <defs>
