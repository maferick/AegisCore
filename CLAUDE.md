...
7. [0012](docs/adr/0012-single-operator-ai-assist.md) — single-operator AI assist policy
8. [0013](docs/adr/0013-hypothesis-confidence-framing.md) — hypothesis-confidence framing (amends 0012; replaces topic-based forbidden list with guarantee-based ladder)
